 ...
 * @since AM 5.5.0
 */
public class VerimiLoginPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(VerimiLoginPlugin.currentVersion, 
				Collections.singletonList(VerimiLogin.class));
	}
	...
	public String getPluginVersion() {
		return VerimiLoginPlugin.currentVersion;
	}
}
